...
public class Solution {
	...
	private static boolean depthFirstSearch(int leap, int[] game, int indexInArray) {
		...
		//check if your index is below 0 (out of bound) and if your index has stored the value 1
		...
		return depthFirstSearch(leap, game, indexInArray - 1) || depthFirstSearch(leap, game, indexInArray + 1) || depthFirstSearch(leap, game, indexInArray + leap);
	}
